                ...
                <div class="home-wrap">
                    ...
                    <div id="home-slick">
                        ...
                        <div class="banner banner-1">
                            <img src="{{ asset('frontend/eshop/banner/banner01.jpg') }}" alt="">
                            <div class="banner-caption text-center">
                                <h1>Bags sale</h1>
                        ...
                        <!-- banner -->
                        <div class="banner banner-1">
                            <img src="{{ asset('frontend/eshop/banner/banner02.jpg') }}" alt="">
                        ...
                        <!-- banner -->
                        <div class="banner banner-1">
                            <img src="{{ asset('frontend/eshop/banner/banner03.jpg') }}" alt="">
                            <div class="banner-caption">
