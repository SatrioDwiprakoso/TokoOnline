    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    $('#checkShipping').click(function() {
                        ...
                        const formData =
                            `origin=${origin}&destination=${destination}&weight=${weight}&courier=${courier}&price=lowe
st`;
                        console.log("Form Data:", formData);
                        document.getElementById('loading').style.display = 'block'; //menampilkan 
                        loading
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.data) {
                                    let html = `<strong>Daftar Layanan 
(${courier.toUpperCase()}):</strong><ul>`;
